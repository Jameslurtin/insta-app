      ...
      </div>
      {
        signup ? <div>
          <div className='  w-[500px] h-[500px] -mt-36  flex  flex-col items-center  justify-evenly  bg-white border-b-4 border-t-4 border-l-4 border-r-4 ml-24'>
            <img className='mt-44' src={Instalogimage}></img>
            ...
            <div className='  relative mt-11 bottom-1 flex gap-2 '>
              <img className='w-5 ' src='https://cdn-icons-png.flaticon.com/512/124/124010.png' alt=''></img>
              <h1 className='text-[#3851A5] font-bold   text-[18px] '>Log in with Facebook</h1>
            </div>
            ...
            <div className=' w-[500px] h-[300px]  mt-28 flex  flex-col items-center  bg-white border-b-4 border-t-4 border-l-4 border-r-4 px-3 pt-3 pb-3 '>
              ...
              <h1 className='text-[#3851A5] absolute ml-36' onClick={() => { setsignup(!signup) }}>Sign up</h1>
          ...
          <img className='flex justify-center items-center mt-40' src={Instalogimage}></img>
          <h className='text-[#A98B77] font-serif font-semibold text-lg flex items-center justify-evenly mt-4
'>Sign up to see photos and videos <br></br>from your friends.</h>
          <div className='  relative  bottom-1 flex gap-2  mt-7'>
            <button className='bg-[#0095F6]  flex justify-center items-center px-10 py-2 gap-3 rounded-lg'>
              ...
              <h1 className='text-white font-bold   text-[18px]  '>Log in with Facebook</h1>
...
<p className='ml-10 mt-5'>By signing up, you agree to our Terms , Privacy Policy and Cookies Policy .
          ...
          Have an account? <h className='text-blue-400 ml-48 -mt-6'>Log in</h>
        </div>
